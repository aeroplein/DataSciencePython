...
city_concept_season = pd.pivot_table(df, index=["SaleCityName", "ConceptName" , "Seasons"], values="Price", aggfunc=["mean", "count"])
season_concept_cin = pd.pivot_table(df, index=["Seasons","ConceptName" ,"CInDay"], values="Price", aggfunc=["mean", "count"])
